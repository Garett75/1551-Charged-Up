...
public static final int DEPLOY_INTAKE_MOTOR_ID = 0;*/
 ...
 // public static RelativeEncoder right_encoder = DriveTrain.m_right_1.getEncoder();
  ...
  public static boolean intake_state;

  private final I2C.Port i2cPort = I2C.Port.kOnboard;
  private final ColorSensorV3 m_colorSensor = new ColorSensorV3(i2cPort);
  private final ColorMatch m_colorMatcher = new ColorMatch();
  private final DigitalInput conveyor_beam_break = new DigitalInput(Constants.CONVEYOR_BEAM_BREAK_ID);
  ...
  public void robotPeriodic() {
    ...
    left_drive_1_current = power_hub.getCurrent(5);
    conveyor_motor_current = power_hub.getCurrent(7);
    ...
    double intake_encoder = Deploy_Intake_Motor.intake_encoder.getPosition();
    ...
    SmartDashboard.putNumber("intake_encoder", intake_encoder);
    SmartDashboard.putBoolean("intake_in", intake_in);
