...
public static final int PS4CONTROLLER_DRIVE_ID = 1;
public static final int PS4CONTROLLER_OTHER_ID = 0;
...
public static final double DEPLOY_INTAKE_MOTOR_SPEED = .15;
...
public static final int CONVEYOR_BEAM_BREAK_ID = 5;
...
public static final double DEPLOY_INTAKE_STOP_POSITION = 5;
public static final double RETRACT_INTAKE_STOP_POSITION = 4;
