...
public class Deploy_Intake extends CommandBase {
  public static boolean stop;
  private Deploy_Intake_Motor m_deploy_intake_Motor;


  /** Creates a new Raise_Arm_High. */
  public Deploy_Intake(Deploy_Intake_Motor m_deploy_intake_Motor) {
  ...
  @Override
  public void execute() {
    final double stop_position = Constants.DEPLOY_INTAKE_STOP_POSITION - (Math.abs(Deploy_Intake_Motor.intake_encoder.getPosition()+1));
