...
public class Extend_Command_Group extends SequentialCommandGroup {
  /** Creates a new Shoot_High_Command_Group2. */
  public Extend_Command_Group(Arm_Up_Down_Motor arm_up_down_motor, Pneumatics pneumatics, Extend_Arm_Motor extend_arm_motor) {
