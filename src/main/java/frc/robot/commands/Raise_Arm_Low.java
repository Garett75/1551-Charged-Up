...
public class Raise_Arm_Low extends CommandBase {
  private Arm_Up_Down_Motor m_arm_up_down_motor;
  public static double goal2;
  boolean stop;
  /** Creates a new Raise_Arm_High. */
  public Raise_Arm_Low(Arm_Up_Down_Motor m_arm_up_down_motor) {
  ...
  @Override
  public void execute() {
    goal2 = (Constants.RAISE_ARM_LOW_TARGET -Math.abs(Robot.m_encoder.getDistance()));
