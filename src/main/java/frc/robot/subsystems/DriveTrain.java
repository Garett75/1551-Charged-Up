...
public class DriveTrain extends SubsystemBase {
  ...
  public static double right_current = m_right_1.get();
  ...
  public DriveTrain() {
    ...
    m_left_1.getEncoder().setVelocityConversionFactor(.477/10.75);
    m_right_1.getEncoder().setVelocityConversionFactor(.477/10.75);
