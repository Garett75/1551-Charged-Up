...
public class Pneumatics extends SubsystemBase {
  ...
  public final DoubleSolenoid intake_solenoid = new DoubleSolenoid(1, PneumaticsModuleType.REVPH, Constants.INTAKE_SOLENOID_IN, Constants.INTAKE_SOLENOID_OUT);
